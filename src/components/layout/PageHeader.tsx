...
export function PageHeader({ 
  ...
  return (
    <div className={cn("layout-stack mb-layout-gap-lg", className)}>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-layout-gap-lg py-header-padding-y px-card-padding bg-white/40 dark:bg-black/40 backdrop-blur-xl rounded-card border border-border/10 shadow-sem-sm">
