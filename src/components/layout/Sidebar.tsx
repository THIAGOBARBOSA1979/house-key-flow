      ...
      <div className="flex flex-col items-center justify-center py-8 px-5 border-b border-sidebar-border/10">
        {!collapsed ? (
          <div className="flex flex-col items-center gap-6 animate-in fade-in zoom-in duration-700">
            <div className="w-20 h-20 rounded-[2rem] bg-gradient-to-br from-sidebar-primary to-sidebar-primary/60 flex items-center justify-center shadow-sem-xl overflow-hidden ring-4 ring-sidebar-primary/10 border border-white/10 group cursor-pointer hover:rotate-3 transition-all duration-slow">
               {company?.settings?.logo_url ? (
                 <img src={company.settings.logo_url} alt="Logo" className="w-full h-full object-cover" />
               ) : (
                 <Building className="text-sidebar-primary-foreground h-10 w-10" />
               )}
            </div>
            <div className="text-center space-y-2">
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-sidebar-primary/10 border border-sidebar-primary/20">
                <span className="w-1.5 h-1.5 rounded-full bg-sidebar-primary animate-pulse" />
                <p className="text-[10px] font-black text-sidebar-primary uppercase tracking-[0.2em] opacity-90">Enterprise v3.1</p>
              </div>
            </div>
          </div>
        ) : (
          <div className="w-12 h-12 rounded-2xl bg-sidebar-primary flex items-center justify-center shadow-sem-lg animate-in fade-in zoom-in duration-500 hover:scale-110 transition-transform cursor-pointer">
