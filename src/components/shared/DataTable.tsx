...
function DataTableComponent<T>({
  ...
  return (
    <div className={cn("w-full animate-fade-in group/table-container", className)}>
      <div className="hidden lg:block rounded-card-radius border border-border/10 shadow-sem-md bg-white/40 backdrop-blur-3xl overflow-hidden relative transition-all duration-500 hover:shadow-sem-xl hover:border-border/20">
