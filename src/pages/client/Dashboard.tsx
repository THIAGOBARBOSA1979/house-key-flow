    ...
    <div className="container-responsive py-4 sm:py-8 space-y-8 sm:space-y-12 animate-in fade-in duration-slow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-8">
          <TechnicalSheet 
            propertyArea={profile?.totalArea ? parseFloat(profile.totalArea) : propertyData?.totalArea}
            deliveryDate={userInfo.deliveryDate?.toLocaleDateString('pt-BR', { month: 'short', year: 'numeric' })}
            solarPosition={profile?.governance_metadata?.solar_position}
            parkingSpots={profile?.governance_metadata?.parking_spots}
          />
